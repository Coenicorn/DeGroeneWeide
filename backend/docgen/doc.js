...
export class APIDocGenerator extends DocGenerator {
    ...
    _toIsPublicString(yes) {
        let str;
        if (yes) str = "![img_public](https://github.com/Coenicorn/DeGroeneWeide/blob/resize-public-private-img/backend/docgen/public.png?raw=true)";
        else str = "![img_private](https://github.com/Coenicorn/DeGroeneWeide/blob/resize-public-private-img/backend/docgen/private.png?raw=true)";
        return str;
    }
